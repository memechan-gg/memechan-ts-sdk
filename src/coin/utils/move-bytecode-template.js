// https://github.com/interest-protocol/sui-coins/blob/main/views/create-token/create-token-form/move-bytecode-template.js
...
export function update_constants(binary, new_value, expected_value, expected_type) {
  try {
    ...
    const v5 = getArrayU8FromWasm0(r0, r1).slice();
    wasm.__wbindgen_free(r0, r1 * 1);
    return v5;
  } finally {
    wasm.__wbindgen_add_to_stack_pointer(16);
